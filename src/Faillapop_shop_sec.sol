...
//TODO import openzeppelin GuardReentrancy
    ...
    */
    ...
    function closeSale(uint256 itemId, bool reimburseBuyer, bool paySeller, bool releaseSellerStake) public { 
        ...
        if (paySeller) {
            ...
            (bool success, ) = payable(seller).call{value: price}("");//Reentrancy? Patrón CEI. call deprecated. Logica
            require(success, "Sale payment failed");
        }      
