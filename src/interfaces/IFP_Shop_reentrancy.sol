...
import {IFP_Shop} from "./IFP_Shop.sol";
...
*/
interface IFP_Shop_reentrancy is IFP_Shop {
    /**
    ...
    */
    ...
    function closeSale(uint256 itemId, bool reimburseBuyer, bool paySeller, bool releaseSellerStake) external; //not present in original IFP, useful for attack
